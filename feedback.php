...
<?php
            ...
            include("connect.php");
            $sql="INSERT INTO feedback(firstname,lastname,Contactnumber,comments)
            VALUES('$_POST[firstname]','$_POST[lastname]','$_POST[Contactnumber]','$_POST[comments]')";

            if (!mysqli_query($conn,$sql))
            {
              die('Error: ' . mysqli_error());
            }
            echo "<script type='text/javascript'>alert('Feedback successfully stored')</script>";
